...
// contract ExtendedNFT is GenericNFT {
...
//     function setNFTBeacon(address _template) external virtual onlyRole(UPGRADER_ROLE) {
//         beaconAddress = _template;
//     }
    
//     function contains(address _provinceAddress) external view virtual returns(bool)
//     {
//         return lookup.contains(_provinceAddress);
//     }

//     function addSvgResouces(uint256 id, string memory svg) external virtual onlyRole(DEFAULT_ADMIN_ROLE)
//     {
//         svgResources[id] = svg;
//     }
...
//     function tokenURI(uint256 tokenId) override(ERC721Upgradeable) public pure returns (string memory) {
